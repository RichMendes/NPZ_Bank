...
//===========================================
   ...
   static int Port_to_Server = 14001;
   static int Port_from_Server = 14002;
  ...
  //**************
   ...
   String QflagName = "Bank-f-Qc.dat"; // Lock Flag-File for Question (DATA at Client to send to Server)
   String QnameAtC = "Bank-Qc.dat";   // Question-File name (of DATA=QUESTION) at Client to send to Server
   String QnameAtS = "Qs.dat";   // Question-File name (of DATA=QUESTION) to be GIVEN to the Server to write at Server

   String AflagName = "Bank-f-Ac.dat"; // Lock Flag-File for ANSWER (DATA at Client to send to Server)
   String AnameAtC = "Bank-Ac.dat";    // Answer-File name used to write the DATA=ANSWER 
